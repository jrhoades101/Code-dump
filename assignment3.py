...
#I used several while loops to check the user's inputed number, if it is above 0 then the program proceeds, if it does
# not meet the requirements, it will give an error command.
    while range_start < 0:
        print("Error! Please enter an integer that is above 0.")
        range_start = float(input("Enter a positive integer value to start your range: "))
